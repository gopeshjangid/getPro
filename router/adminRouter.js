...
adminRouter
    .route('/users')
    .get(authController.checkLogin,authController.checkFaq, adminController.users);
adminRouter
    .route('/updateUser/:id')
...
adminRouter
    .route('/query')
    .get(authController.checkLogin,authController.checkFaq, adminController.query);
adminRouter
    .route('/contact-us')
    .post(adminController.queryAdd);
adminRouter
    .route('/workSample')
    .get(authController.checkLogin,authController.checkFaq, adminController.worksample);
adminRouter
...
adminRouter
    .route('/authors')
    .get(authController.checkLogin,authController.checkFaq, adminController.authors)
adminRouter
...
adminRouter
    .route('/faqs')
    .get(authController.checkLogin,authController.checkFaq, adminController.faqs)
adminRouter
    .route('/faqReadMore/:id')
    .get(authController.checkLogin,authController.checkFaq, adminController.FaqReadMore)
adminRouter
    .route('/addFaqs')
    .get(authController.checkLogin,authController.checkFaq, adminController.addFaqs)
    .post(adminController.addFaqsSubmit)
adminRouter
    .route('/updateFaqs/:id')
    .get(authController.checkLogin,authController.checkFaq, adminController.updateFaqs)
    .post(adminController.updateFaqsSubmit)
 adminRouter
    .route('/deleteFaqs/:id')
    .get(authController.checkLogin,authController.checkFaq, adminController.deleteFaqs)

adminRouter
    .route('/blog')
    .get(authController.checkLogin,authController.checkFaq, adminController.blog)
adminRouter
...
adminRouter
    .route('/services')
    .get(authController.checkLogin,authController.checkFaq, adminController.services)
adminRouter
...
adminRouter
    .route('/coupon')
    .get(authController.checkLogin,authController.checkFaq, adminController.coupon)
adminRouter
    .route('/addcoupon')
...
adminRouter
    .route('/career')
    .get(authController.checkLogin,authController.checkFaq, adminController.career)
adminRouter
    .route('/addcareer')
...
adminRouter
    .route('/chats')
    .get(authController.checkLogin,authController.checkFaq, adminController.chats)
adminRouter
    .route('/adminWalletHistory')
    .get(authController.checkLogin,authController.checkFaq, adminController.adminWalletTransactionHistory)
adminRouter
    .route('/adminOrderHistory')
    .get(authController.checkLogin,authController.checkFaq, adminController.adminOrderHistory)
adminRouter
...
adminRouter
    .route('/extraCredit')
    .get(authController.checkLogin,authController.checkFaq, adminController.extraCredit)
adminRouter
...
adminRouter
    .route('/contentType')
    .get(authController.checkLogin,authController.checkFaq, adminController.contentType)
adminRouter
...
adminRouter
    .route('/expertLevel')
    .get(authController.checkLogin,authController.checkFaq, adminController.expertLevel)
adminRouter
